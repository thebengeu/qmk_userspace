...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [4] = {ENCODER_CCW_CW(KC_F1, KC_F2), ENCODER_CCW_CW(QK_AREP, QK_REP)},
    [5] = {ENCODER_CCW_CW(KC_LEFT, KC_RIGHT), ENCODER_CCW_CW(KC_NO, KC_NO)},
    [6] = {ENCODER_CCW_CW(S(KC_H), S(KC_L)), ENCODER_CCW_CW(KC_NO, KC_NO)},
