...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM] = LAYOUT_split_3x5_3(
    G(KC_Q),        G(KC_W),        LSG(KC_LBRC),   LSG(KC_RBRC),     G(KC_T),       KC_NO,            KC_1,             KC_2,           KC_3,           LT(1,KC_PLUS),
    GUI_T(KC_LCBR), ALT_T(RCBR),    CTL_T(KC_LPRN), SFT_T(KC_RPRN),   LT(0,KC_DLR),  LT(0,KC_EQL),     KC_4,             KC_5,           KC_6,           KC_COLN,
    G(KC_GRV),      SHIFT_GUI_TAB,  GUI_TAB,        KC_PERC,          KC_NO,         LT(0,KC_COMM),    KC_7,             KC_8,           KC_9,           NW_TOGG,
